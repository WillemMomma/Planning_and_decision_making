...
def initMap(otherrobots, maps, start_position):
    if maps == 0:
        ...
        if otherrobots == True and maps == 1:
            mountPositions = np.array(
                [
                    (start_position[0], start_position[1], 0), (6, -8, 0), (-6, 8, 0), (4, 0.5, 0), (-6, -0.5, 0),
                    (-12, -0.5, 0), (12, 0.5, 0)
                ]
            )
        if otherrobots == True and maps == 2:
            mountPositions = np.array(
                [
                    (start_position[0], start_position[1], 0), (5, -8, 0), (-3, 8, 0), (3, 0.5, 0), (-5, -0.5, 0),
                    (-11, -0.5, 0), (11, 0.5, 0)
                ]
            )
    ...
    if maps == 3:
        mountPositions = np.array(
            [
                (start_position[0], start_position[1], 0), (-7, -4, 0), (-7, -2, 0), (-7, 0, 0), (-7, 2, 0), (-7, 4, 0),
                (-7, 6, 0),
